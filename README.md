...
This branch (*release-trigger-revision*) is a [**release trigger branch**](#release-trigger-branch) for the **T³** project.
...
To trigger a new release with *revision* increment policy, simply [run a new pipeline](https://git.teecu.be/teecube/t3/pipelines/new) after selecting *release-trigger-revision* in the list.
That's it !
...
These versions numbers can also be [edited directly in Gitlab](https://git.teecu.be/teecube/t3/edit/release-trigger-revision/release.properties).
